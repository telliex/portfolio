...
function ThemeDropdown() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute top-full right-0 z-50 mt-1 w-28 overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-md dark:border-zinc-800 dark:bg-zinc-900">
...
function LangDropdown() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute top-full right-0 z-50 mt-1 w-24 overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-md dark:border-zinc-800 dark:bg-zinc-900">
      ...
      <div className="mx-auto w-full max-w-screen-sm px-4">
        ...
        <div className="flex items-center justify-between py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <LangDropdown />
            <button
              className="rounded-lg p-1.5 text-zinc-500 hover:bg-zinc-100 md:hidden dark:text-zinc-400 dark:hover:bg-zinc-800"
        ...
        <p className="hidden pb-4 text-sm text-zinc-500 md:block dark:text-zinc-500">
          {t.headerSubtitle}
        </p>
